...
public class Task {
    ...
    public Task(Long id, User user, String title, String description, LocalDate taskDate, LocalTime taskTime,
    ...
    public static class TaskBuilder {
        ...
        public TaskBuilder taskTime(LocalTime taskTime) {
            this.taskTime = taskTime;
            return this;
        }
        ...
        public Task build() {
            return new Task(id, user, title, description, taskDate, taskTime, category, urgency,
